package person.leomao.leovalidation.common.model.enums;


/**
 * <pre>
 * global response code and it's meaning,
 * {@link person.leomao.leovalidation.exception.GlobalExceptionHandler}
 *
...
public enum ResultCode {
    ...
    //**********************************************************************
    SCENE_CATEGORY_HAS_CHILD_EXCEPTION("SCENE_CATEGORY_2001", "当前分类下存在子分类，无法删除"),
    SCENE_CATEGORY_HAS_BODY_EXCEPTION("SCENE_CATEGORY_2002", "当前分类下存在场景，无法删除"),
